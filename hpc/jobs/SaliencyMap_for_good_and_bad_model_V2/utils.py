...
def get_training_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    LOCAL_PATH = "data/datasetCIFAR100"
    GBAR_PATH = "../data/datasetCIFAR100"
    cifar100_training = torchvision.datasets.CIFAR100(root=GBAR_PATH, train=True, download=True, transform=transform_train)
...
def get_test_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    LOCAL_PATH = "data/datasetCIFAR100"
    GBAR_PATH = "../data/datasetCIFAR100"
    cifar100_test = torchvision.datasets.CIFAR100(root=GBAR_PATH, train=False, download=True, transform=transform_test)
